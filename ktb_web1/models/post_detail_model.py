...
from models.posts_model import POSTS, format_count

# 댓글 데이터 저장소
COMMENTS = {
    1: [
        {"id": 1, "text": "첫 번째 댓글입니다", "created_at": "2025-01-10 04:00:00"},
        {"id": 2, "text": "두 번째 댓글입니다", "created_at": "2025-01-10 05:00:00"},
    ],
    2: [],
    3: []
}
